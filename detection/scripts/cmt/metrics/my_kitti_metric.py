...
class My_KittiMetric(BaseMetric):
    ...
    def __init__(self,
                 ...
                 pcd_limit_range: List[float] = [0, -18, -5, 36, 18, 1],
                 prefix: Optional[str] = None,
                 pklfile_prefix: Optional[str] = None,
                 default_cam_key: str = 'left',
                 format_only: bool = False,
                 submission_prefix: Optional[str] = None,
                 collect_device: str = 'cpu',
                 backend_args: Optional[dict] = None) -> None:
        self.default_prefix = 'Kitti metric'
        super(My_KittiMetric, self).__init__(
    ...
    def bbox2result_kitti(
        ...
        """
        print(len(net_outputs), len(self.data_infos))
        ...
        for idx, pred_dicts in enumerate(
            ...
            if len(box_dict['bbox']) > 0:
                ...
                for box, box_lidar, bbox, score, label in zip(
                        box_preds_lidar, box_preds_lidar, box_2d_preds, scores,
                        label_preds):
